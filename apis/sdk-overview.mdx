...
- `baseURL` (string, optional): Custom API base URL (for development or custom servers)
- `headers` (object, optional): Additional headers as key-value pairs (for custom authentication)
